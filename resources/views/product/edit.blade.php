         ...
         <div class="row">
            <div class="col-lg-8 offset-lg-2">
               ...
               <div class="card card-info">
                  ...
                  <!-- /.card-header -->
                  <!-- form start -->
                  <form class="form-horizontal" id="addCategory" enctype='multipart/form-data' method="POST" action="{{route('product.update', $product->id)}}">
                     @csrf
                     @method('patch')
                     <div class="card-body">
                        <div class="form-group row">
                           ...
                           <div class="col-sm-10">
                              <input type="text" class="form-control {{$errors->has('name') ? 'is-invalid' : ''}}" id="name" name="name" placeholder="Product Name" value="{{$product->name ?? old('name')}}">
                              @if($errors->has('name'))
                        ...
                        <div class="form-group row">
                           ...
                           <div class="col-sm-10">
                              <input type="text" class="form-control {{$errors->has('title') ? 'is-invalid' : ''}}" id="title" name="title" placeholder="Product Title" value="{{$product->title ?? old('title')}}">
                              @if($errors->has('title'))
                                 <div class="text-danger mt-2">
                                    {{$errors->first('title')}}
                                 </div>
                        ...
                        <div class="form-group row">
                           ...
                           <div class="col-sm-10">
                              <input type="text" class="form-control {{$errors->has('product_code') ? 'is-invalid' : ''}}" id="product_code" name="product_code" placeholder="Product Code" value="{{$product->product_code ?? old('product_code')}}">
                        ...
                        <div class="form-group row">
                           ...
                           <div class="col-sm-10">
                              <input type="number" class="form-control {{$errors->has('pack_barcode') ? 'is-invalid' : ''}}" id="pack_barcode" name="pack_barcode" placeholder="Pack Barcode" value="{{$product->pack_barcode ?? old('pack_barcode')}}">
                        ...
                        <div class="form-group row">
                           ...
                           <div class="col-sm-10">
                              <input type="number" class="form-control {{$errors->has('single_barcode') ? 'is-invalid' : ''}}" id="single_barcode" name="single_barcode" placeholder="Single Barcode" value="{{$product->single_barcode ?? old('single_barcode')}}">
                        ...
                        <div class="form-group row">
                           ...
                           <div class="col-sm-10">
                              <input type="text" class="form-control {{$errors->has('size') ? 'is-invalid' : ''}}" id="size" name="size" placeholder=" Size" value="{{$product->size ?? old('size')}}">
                              @if($errors->has('size'))
                                 <div class="text-danger mt-2">
                                    {{$errors->first('size')}}
                                 </div>
                        ...
                        <div class="form-group row">
                           ...
                           <div class="col-sm-10">
                              <input type="text" class="form-control {{$errors->has('type') ? 'is-invalid' : ''}}" id="type" name="type" placeholder="Type" value="{{$product->type ?? old('type')}}">
                              @if($errors->has('type'))
                                 <div class="text-danger mt-2">
                                    {{$errors->first('type')}}
                                 </div>
                        ...
                        <div class="form-group row">
                           ...
                           <div class="col-sm-10">
                              <input type="number" class="form-control {{$errors->has('vat_code') ? 'is-invalid' : ''}}" id="vat_code" name="vat_code" placeholder="VAT Code" value="{{$product->vat_code ?? old('vat_code')}}">
                        ...
                        <div class="form-group row">
                           ...
                           <div class="col-sm-10">
                              <input type="number" step="0.01" class="form-control {{$errors->has('cost_price') ? 'is-invalid' : ''}}" id="cost_price" name="cost_price" placeholder="Cost Price 12.25" value="{{$product->cost_price ?? old('cost_price')}}">
                        ...
                        <div class="form-group row">
                           ...
                           <div class="col-sm-10">
                              <input type="number" step="0.01" class="form-control {{$errors->has('pack_price') ? 'is-invalid' : ''}}" id="pack_price" name="pack_price" placeholder="Pack Price" value="{{$product->pack_price ?? old('pack_price')}}">
                        ...
                        <div class="form-group row">
                           ...
                           <div class="col-sm-10">
                              <input type="number" step="0.01" class="form-control {{$errors->has('single_price') ? 'is-invalid' : ''}}" id="single_price" name="single_price" placeholder="Single Price" value="{{$product->single_price ?? old('single_price')}}">
                        ...
                        <div class="form-group row">
                           ...
                           <div class="col-sm-10">
                              <input type="number" step="0.01" class="form-control {{$errors->has('layer_price') ? 'is-invalid' : ''}}" id="layer_price" name="layer_price" placeholder="Layer Price" value="{{$product->layer_price ?? old('layer_price')}}">
                        ...
                        <div class="form-group row">
                           ...
                           <div class="col-sm-10">
                              <input type="number" step="0.01" class="form-control {{$errors->has('pallet_price') ? 'is-invalid' : ''}}" id="pallet_price" name="pallet_price" placeholder="Pallet Price" value="{{$product->pallet_price ?? old('pallet_price')}}">
                        ...
                        <div class="form-group row">
                           ...
                           <div class="col-sm-10">
                              <input type="number" step="0.01" class="form-control {{$errors->has('case_qty') ? 'is-invalid' : ''}}" id="case_qty" name="case_qty" placeholder="Case Quantity" value="{{$product->case_qty ?? old('case_qty')}}">
                        ...
                        <div class="form-group row">
                           ...
                           <div class="col-sm-10">
                              <input type="number" step="0.01" class="form-control {{$errors->has('layer_qty') ? 'is-invalid' : ''}}" id="layer_qty" name="layer_qty" placeholder="Layer Quantity" value="{{$product->layer_qty ?? old('layer_qty')}}">
                        ...
                        <div class="form-group row">
                           ...
                           <div class="col-sm-10">
                              <input type="number" step="0.01" class="form-control {{$errors->has('pallet_qty') ? 'is-invalid' : ''}}" id="pallet_qty" name="pallet_qty" placeholder="Pallet Quantity" value="{{$product->pallet_qty ?? old('pallet_qty')}}">
                        ...
                        <div class="form-group row">
                           ...
                           <div class="col-sm-10">
                              <input type="number" step="0.01" class="form-control {{$errors->has('total_stock') ? 'is-invalid' : ''}}" id="total_stock" name="total_stock" placeholder="Total Stock" value="{{$product->total_stock ?? old('total_stock')}}">
